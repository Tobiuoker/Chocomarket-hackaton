//
//  myDeliveryProductsTableViewController.swift
...
class myDeliveryProductsTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "message"{
            let destin = segue.destination as? ChatViewController
            destin?.idZakaza = id
        }
    }
...
//        print()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "myDeliveryProducts", for: indexPath)
